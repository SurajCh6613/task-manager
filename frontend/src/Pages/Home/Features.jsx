...
const Features = () => {
  return (
    <section className="flex flex-col justify-center items-center bg-gray-100 py-8 px-3">
      ...
      <div className="grid md:grid-cols-2 max-w-6xl gap-8 mx-auto">
        <div className="p-6 bg-white rounded-2xl shadow-lg text-center">
          <PlusCircle className="mx-auto w-12 h-12 text-indigo-600 mb-4" />
        ...
        <div className="p-6 bg-white rounded-2xl shadow-lg text-center">
          <CheckCircle className="mx-auto w-12 h-12 text-indigo-600 mb-4" />
          <h3 className="text-xl font-semibold mb-2">View All Tasks</h3>
          <p className="">
        ...
        <div className="p-6 bg-white rounded-2xl shadow-lg text-center">
          <Edit3 className="mx-auto w-12 h-12 text-indigo-600 mb-4" />
        ...
        <div className="p-6 bg-white rounded-2xl shadow-lg text-center">
          <Trash2 className="mx-auto w-12 h-12 text-indigo-600 mb-4" />
          <h3 className="text-xl font-semibold mb-2">Delete Task</h3>
          <p className="">
            Remove completed or unwanted tasks to stay clutter-free.
          </p>
        </div>
        <div className="p-6 bg-white rounded-2xl shadow-lg text-center md:col-span-2">
          <Bell className="mx-auto w-12 h-12 text-indigo-600 mb-4" />
