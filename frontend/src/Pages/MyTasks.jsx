              ...
              {tasks.map((task, index) => (
                <li key={task.id} className="border p-4 rounded">
                  ...
                  <div className="flex space-x-4 w-2/3">
                    <Link to="/editTask"><button className="py-3">Edit <FaEdit className="inline h-6 w-6 text-gray-500" /></button></Link>
                    <button>Delete <MdDelete className="inline w-6 h-6 text-red-500" /></button>
                  </div>
                </li>
              ))}
            </ul>
